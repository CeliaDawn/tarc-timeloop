...
const u16 gMetatiles_NewPrimary[] = INCBIN_U16("data/tilesets/primary/new_primary/metatiles.bin");
const u16 gMetatileAttributes_NewPrimary[] = INCBIN_U16("data/tilesets/primary/new_primary/metatile_attributes.bin");
