...
const struct Tileset gTileset_NewPrimary =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_NewPrimary,
    .palettes = gTilesetPalettes_NewPrimary,
    .metatiles = gMetatiles_NewPrimary,
    .metatileAttributes = gMetatileAttributes_NewPrimary,
    .callback = NULL,
};
